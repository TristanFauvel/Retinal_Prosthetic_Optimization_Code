...
if reload == 1 %full reload
    N = -1;
    [RMSE.rmse_stim_optimized_preference_acq, RMSE.rmse_opt_optimized_preference_acq]= load_RMSE('preference', 'MUC', 0,N, data_table_file, data_directory);
    ...
    [RMSE.rmse_stim_optimized_preference_acq_misspecification, RMSE.rmse_opt_optimized_preference_acq_misspecification] = load_RMSE('preference', 'MUC', 1, N, data_table_file, data_directory);
