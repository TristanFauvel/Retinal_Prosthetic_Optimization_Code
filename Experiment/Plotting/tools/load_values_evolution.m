...
if reload
    val_evo.optimized_preference_acq= load_val('preference', 'MUC', 0, data_table_file, data_directory);
    val_evo.optimized_preference_random = load_val('preference', 'random', 0, data_table_file, data_directory);
    val_evo.optimized_preference_acq_misspecification = load_val('preference', 'MUC', 1, data_table_file, data_directory);
