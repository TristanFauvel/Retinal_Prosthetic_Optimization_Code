...
linecol= [0,0,0];
offset = 0.5;
h =bar(data, 0.9, 'EdgeColor', 'w'); hold on
...
errorbar(e',data, sem,'k','linestyle','none', 'LineWidth', 2);
hold off
...
rotation = 0;
 ...
 for i = 1:Nx
    ...
    pvalsx(i) = px;
    pvalsy(i) = py;
    [stars_x{i},~]= disp_p(px, 'test', test, 'n', nx(i), 'plot_N', plot_N, 'style', 'short');
    [stars_y{i},~]= disp_p(py, 'test', test, 'n', ny(i), 'plot_N', plot_N, 'style', 'short');
