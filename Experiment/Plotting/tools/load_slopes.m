...
if reload
    [slope_E_optimized_preference_acq, slope_Snellen_optimized_preference_acq]= load_slope('preference', 'MUC', 0);
    ...
    [slope_E_optimized_preference_acq_misspecification, slope_Snellen_optimized_preference_acq_misspecification] = load_slope('preference', 'MUC', 1);
