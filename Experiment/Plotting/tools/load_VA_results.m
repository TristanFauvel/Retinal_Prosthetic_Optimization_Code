function VA = load_VA_results(reload, data_directory, data_table_file, varargin)
...
if reload == 1 %full reload
    N = -1;
    [VA.VA_E_optimized_preference_acq, VA.VA_Snellen_optimized_preference_acq]= load_VA('preference', 'MUC', 0,N, data_table_file, data_directory, subjects_to_keep);
    [VA.VA_E_optimal,VA.VA_Snellen_optimal] = load_VA([], 'optimal', 0,N, data_table_file, data_directory, subjects_to_keep);
    [VA.VA_E_optimized_preference_random,VA.VA_Snellen_optimized_preference_random] = load_VA('preference', 'random', 0,N, data_table_file, data_directory, subjects_to_keep);
    [VA.VA_E_optimized_preference_acq_misspecification, VA.VA_Snellen_optimized_preference_acq_misspecification] = load_VA('preference', 'MUC', 1, N, data_table_file, data_directory, subjects_to_keep);
    [VA.VA_E_optimal_misspecification,VA.VA_Snellen_optimal_misspecification] = load_VA([], 'optimal', 1, N, data_table_file, data_directory, subjects_to_keep);
    [VA.VA_E_optimized_E_TS,VA.VA_Snellen_optimized_E_TS] = load_VA('E', 'TS_binary', 0, N, data_table_file, data_directory, subjects_to_keep);
    [VA.VA_E_control,VA.VA_Snellen_control] = load_VA([], 'control', 0, N, data_table_file, data_directory, subjects_to_keep);
    [VA.VA_E_naive,VA.VA_Snellen_naive] = load_VA([], 'naive', 0, N, data_table_file, data_directory, subjects_to_keep);
    save(filename, 'VA')
elseif reload==0 %use saved data
    ...
    load(filename,'VA');
    N = 4*reload;
    [new_VA_E_optimized_preference_acq, new_VA_Snellen_optimized_preference_acq]= load_VA('preference', 'MUC', 0, N, data_table_file, data_directory, subjects_to_keep);
    [new_VA_E_optimal,new_VA_Snellen_optimal] = load_VA([], 'optimal', 0,N, data_table_file, data_directory, subjects_to_keep);
    [new_VA_E_optimized_preference_random,new_VA_Snellen_optimized_preference_random] = load_VA('preference', 'random', 0,N, data_table_file, data_directory, subjects_to_keep);
    [new_VA_E_optimized_preference_acq_misspecification, new_VA_Snellen_optimized_preference_acq_misspecification] = load_VA('preference', 'MUC', 1,N, data_table_file, data_directory, subjects_to_keep);
    [new_VA_E_optimal_misspecification,new_VA_Snellen_optimal_misspecification] = load_VA([], 'optimal', 1,N, data_table_file, data_directory, subjects_to_keep);
    [new_VA_E_optimized_E_TS,new_VA_Snellen_optimized_E_TS] = load_VA('E', 'TS_binary', 0,N, data_table_file, data_directory, subjects_to_keep);
    [new_VA_E_control,new_VA_Snellen_control] = load_VA([], 'control', 0,N, data_table_file, data_directory, subjects_to_keep);
    [new_VA_E_naive,new_VA_Snellen_naive] = load_VA([], 'naive', 0,N, data_table_file, data_directory, subjects_to_keep);
...
function [VA_E, VA_Snellen]= load_VA(task, exp, misspecification, n, data_table_file, data_directory, subjects_to_keep)
