...
if reload == 1
    N = -1;
    val.optimized_preference_acq = load_val('preference', 'MUC', 0, N, data_table_file, data_directory);
    ...
    val.optimized_preference_acq_misspecification = load_val('preference', 'MUC', 1, N, data_table_file, data_directory);
