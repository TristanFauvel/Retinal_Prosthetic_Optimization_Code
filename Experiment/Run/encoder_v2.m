function [W, Mest, nx, ny] = encoder_v2(xparams, experiment, ignore_pickle, optimal_magnitude, varargin)
% This version of the encoder also takes loc_od_x and lox_od_y into account
...
if save_encoder && isfile(perceptual_model_filename)
    ...
    kwargs = pyargs('rho', rho, 'axlambda', axlambda, 'x', center_x, 'y', center_y, ...
        'z', z, 'rot', rot, 'eye','RE','xrange', py_xrange, 'yrange', py_yrange, ...
        'xystep', xystep, 'n_ax_segments', n_ax_segments, 'n_axons', n_axons, ...
        'beta_sup', beta_sup, 'beta_inf', beta_inf, 'ignore_pickle', ignore_pickle, ...
        'implant_name', experiment.implant_name, 'loc_od_x', loc_od_x, 'loc_od_y', loc_od_y);
