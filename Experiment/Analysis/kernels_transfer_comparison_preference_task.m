...
filename1 = "C:\Users\tfauvel\Documents\Retinal_prosthetic_optimization\Data\Dataset_preference_seed_6.mat";
load(filename1,'experiment')
exp1 = experiment;

filename2 = "C:\Users\tfauvel\Documents\Retinal_prosthetic_optimization\Data\Dataset_preference_seed_99.mat";
...
for i = 1:numel(kernel_list)
    ...
    [mu_c,  mu_y, ~, Sigma2_y] = model.prediction(theta, x_train_norm_data, c_train_data, x_test_norm_data, post);
    mu_c = mu_c';
