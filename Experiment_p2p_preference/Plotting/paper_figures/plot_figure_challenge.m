function plot_figure_challenge(id)
...
%%
%filename = [data_directory, '/Data_Experiment_p2p_preference/BF/BF_maxvar_challenge_experiment_2'];
filename =[data_directory,'/Data_Experiment_p2p_preference/MC/MC_maxvar_challenge_experiment_2'];
...
%       if c == 1
%           i=i+1;
%         text(-0.18,1.15,['$\bf{', letters(i), '}$'],'Units','normalized','Fontsize',letter_font) %with compact margins
%  %       text(-0.146165413533835,1.15,'$\bf{A}$','Units','normalized','Fontsize', letter_font)        
%     end
