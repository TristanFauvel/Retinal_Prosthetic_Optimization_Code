function plot_figure_challenge_VA(id)
...
%%
% idkeep  = acq_vs_opt_training > -1;%>0.16;
% mean(idkeep)
% VA_E_optimized_preference_acq = VA_E_optimized_preference_acq(idkeep);
% VA_Snellen_optimized_preference_acq = VA_Snellen_optimized_preference_acq(idkeep);
% VA_E_optimal = VA_E_optimal(idkeep);
% VA_Snellen_optimal = VA_Snellen_optimal(idkeep);
% VA_E_optimized_preference_random = VA_E_optimized_preference_random(idkeep);
% VA_Snellen_optimized_preference_random = VA_Snellen_optimized_preference_random(idkeep);
% VA_E_control = VA_E_control(idkeep);
% VA_Snellen_control = VA_Snellen_control(idkeep);
% 
