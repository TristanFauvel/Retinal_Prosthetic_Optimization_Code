...
if reload == 1
    n = -1;
    pref_optimized_preference_acq = load_pref('preference', 'maxvar_challenge', 0, n);
    pref_optimal = load_pref([], 'optimal', 0, n);
    pref_optimized_preference_random = load_pref('preference', 'random', 0, n);
    pref_optimized_preference_acq_misspecification = load_pref('preference', 'maxvar_challenge', 1, n);
...
elseif reload == 2
    n = 1;
    new_pref_optimized_preference_acq = load_pref('preference', 'maxvar_challenge', 0, n);
    new_pref_optimal = load_pref([], 'optimal', 0, n);
    new_pref_optimized_preference_random = load_pref('preference', 'random', 0, n);
    new_pref_optimized_preference_acq_misspecification = load_pref('preference', 'maxvar_challenge', 1, n);
