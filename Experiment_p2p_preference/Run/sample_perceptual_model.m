function [rho,lambda, rot, center_x, center_y, magnitude, beta_sup, beta_inf,z, lb, ub] = sample_perceptual_model(to_update,default_values,rho_range,lambda_range,rot_range,center_x_range,center_y_range,beta_sup_range,beta_inf_range,z_range,magnitude_range)


% [d_rho,d_lambda, d_rot, d_center_x, d_center_y, d_magnitude, d_beta_sup, d_beta_inf,d_z] = deal(default_values);
% deal(200,400,0,0,0,175.8257,-1.9,0.5,0);
% 
