...
measure_pref_btw_optimized_encoders(filename1,filename2, 'optimal')

filename2 = filenames{T.Task == 'E' & T.Acquisition ~= 'random'};
measure_pref_btw_optimized_encoders(filename1,filename2, 'E')


filename1 = filenames{T.Task == 'preference' & T.Acquisition ~= 'random' & T.Misspecification ==1};
filename2 = filenames{T.Task == 'preference' & T.Acquisition ~= 'random' & T.Misspecification ==0};
measure_pref_btw_optimized_encoders(filename1,filename2, 'non-misspecified')
...
for k=1:nexp
    ...
    measure_vision_QUEST(filename, test_task, measured_var, 'short_version',2)
end
